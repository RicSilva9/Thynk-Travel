...
const navigation = [{ name: 'Home', href: '#home-id-nav', current: true }];
...
const Nav = () => {
  ...
  return (
    <Disclosure
      as="nav"
      className="fixed top-0 left-0 right-0 z-40 px-4 sm:px-8 md:px-16 sm:mx-4 backdrop-blur bg-slate-900 bg-opacity-40 rounded-b-lg 2xl:m-auto max-w-screen-2xl"
    >
      {({ open }) => (
        <>
          <ModalLogin
